## X-Spam
Brutal Spam Sms,Whatsapp By Ammar Executed & SanzzXD
...
<details open>
  <summary><strong> Install Package + Run Script (SanzzXD)</strong></summary>
  ...
  pkg install git
  pkg install python python2
  git clone https://github.com/SanzzXD/Sw-Spm
  cd Sw-Spm
  bash install.sh
  python sw-spm.py
  ```
